...
public class Main {
    private static final String URL = "jdbc:mysql://localhost:3306/school1";
    private static final String USER = "root";
    private static final String PASSWORD = "Surya@555";
    ...
    private static void retrieveMarkRecord(Statement stmt, Scanner scanner) throws SQLException {
        ...
        String retrieveStudentDetails = "SELECT * FROM school1table3 WHERE name=?";
    ...
    private static void createRecord(Statement stmt, Scanner scanner) throws SQLException {
        ...
        String insertStudentDetails = "INSERT INTO school1table1 VALUES (?, ?, ?, ?, ?)";
        ...
        String insertStudentMarks = "INSERT INTO school1table3 VALUES (?, ?, ?, ?, ?)";
    ...
    private static void readRecords(Statement stmt) throws SQLException {
        ...
        ResultSet resultSet = stmt.executeQuery("SELECT * FROM school1table1");
    ...
    private static void deleteRecord(Statement stmt, Scanner scanner) throws SQLException {
        ...
        int regNo = scanner.nextInt();
        String deleteStudentDetails = "DELETE FROM school1able1 WHERE redgno=?";
